...
execute as @a[tag=!displayRoleDeveloper] as @s[tag=!displayRoleHelper] as @s[tag=!displayRoleYouTuber] as @s[tag=!displayRoleStreamer] as @s[tag=!displayRolePlus] run tag @s add displayRoleMember
