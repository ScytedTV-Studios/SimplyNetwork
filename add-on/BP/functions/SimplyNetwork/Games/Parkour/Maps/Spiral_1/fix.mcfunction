...
kill @e[type=item,name="Sweet Berries",dx=104,dy=178,dz=104,x=1000,y=54,z=1003]

#Diamond Blocks
execute as @a at @s[x=1031,y=97,z=1097,dy=1] run effect @s levitation 3 4 true

#Lava
execute as @a[dx=104,dy=178,dz=104,x=1000,y=54,z=1003,m=!c] run execute as @s at @s positioned ~ ~ ~ if block ~ ~ ~ lava run tellraw @s {"rawtext":[{"text":"§7Teleported back to last Checkpoint."}]}
execute as @a[dx=104,dy=178,dz=104,x=1000,y=54,z=1003,m=!c] run execute as @s at @s positioned ~ ~ ~ if block ~ ~ ~ lava run tag @s add teleportParkour1CheckpointNow
...
#Sweet Berry Bushes 1
fill 1041 76 1096 1042 76 1096 sweet_berry_bush ["growth"=7]
fill 1042 76 1097 1042 76 1097 sweet_berry_bush ["growth"=7]
fill 1043 76 1097 1043 76 1098 sweet_berry_bush ["growth"=7]

fill 1054 76 1098 1056 76 1098 sweet_berry_bush ["growth"=7]
fill 1053 76 1099 1055 76 1099 sweet_berry_bush ["growth"=7]
fill 1054 76 1100 1054 76 1100 sweet_berry_bush ["growth"=7]

fill 1074 76 1098 1074 76 1100 sweet_berry_bush ["growth"=7]
fill 1073 76 1097 1073 76 1100 sweet_berry_bush ["growth"=7]
fill 1072 76 1096 1072 76 1101 sweet_berry_bush ["growth"=7]
fill 1071 76 1098 1071 76 1101 sweet_berry_bush ["growth"=7]
fill 1070 76 1100 1070 76 1102 sweet_berry_bush ["growth"=7]