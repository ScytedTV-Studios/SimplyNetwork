...
# execute as @a at @s[x=,y=,z=,dy=1] run effect @s levitation 3 4 true
...
# fill  farmland ["moisturized_amount"=1]
# fill  potatoes ["growth"=7] replace air
...
# fill  farmland ["moisturized_amount"=1]
# fill  wheat ["growth"=7] replace air
