...
# execute if score reset reset_floating_text_timer >= "0" reset_floating_text_timer run scoreboard objectives setdisplay sidebar reset_floating_text_timer
# execute if score reset reset_floating_text_timer = "0" reset_floating_text_timer run scoreboard objectives setdisplay sidebar