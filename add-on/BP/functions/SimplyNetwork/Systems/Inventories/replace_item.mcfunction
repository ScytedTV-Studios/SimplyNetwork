...
replaceitem entity @a[scores={inventorySlot=0},tag=creatorTools] slot.hotbar 1 simplynetwork:creator_tools 1 1 {"item_lock":{"mode":"lock_in_slot"}}
...
execute as @a[scores={inventorySlot=1}] at @s positioned ~ ~ ~ if block ~ ~ ~ air run replaceitem entity @a[scores={inventorySlot=1}] slot.hotbar 0 simplynetwork:checkpoint 1 1 {"item_lock":{"mode":"lock_in_slot"}}
execute as @a[scores={inventorySlot=1}] at @s positioned ~ ~ ~ if block ~ ~ ~ water run replaceitem entity @a[scores={inventorySlot=1}] slot.hotbar 0 simplynetwork:checkpoint 1 1 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @a[scores={inventorySlot=1}] slot.hotbar 7 simplynetwork:cosmetics 1 1 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @a[scores={inventorySlot=1}] slot.hotbar 8 simplynetwork:back_to_hub 1 1 {"item_lock":{"mode":"lock_in_slot"}}

#Restart
execute as @a[tag=inGameParkour1,scores={parkour_checkpoints=61}] at @s positioned ~ ~ ~ run replaceitem entity @s slot.hotbar 1 simplynetwork:restart_parkour 1 1 {"item_lock":{"mode":"lock_in_slot"}}
execute as @a[tag=inGameParkour1,scores={parkour_checkpoints=!61},hasitem={location=slot.hotbar,slot=1,item=simplynetwork:restart_parkour}] at @s positioned ~ ~ ~ run replaceitem entity @s slot.hotbar 1 air 1 1 {"item_lock":{"mode":"lock_in_slot"}}

execute as @a[tag=inGameParkour2,scores={parkour_checkpoints=123}] at @s positioned ~ ~ ~ run replaceitem entity @s slot.hotbar 1 simplynetwork:restart_parkour 1 1 {"item_lock":{"mode":"lock_in_slot"}}
execute as @a[tag=inGameParkour2,scores={parkour_checkpoints=!123},hasitem={location=slot.hotbar,slot=1,item=simplynetwork:restart_parkour}] at @s positioned ~ ~ ~ run replaceitem entity @s slot.hotbar 1 air 1 1 {"item_lock":{"mode":"lock_in_slot"}}
